...
class RemoteSecurityDataSourceImpl extends BaseRemoteDatasource
    implements IRemoteSecurityDataSource {
  RemoteSecurityDataSourceImpl({required super.dioHelper});
