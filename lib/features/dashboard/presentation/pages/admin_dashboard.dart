  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: const AppDrawer(
        ...
        items: [
          DrawerItem.tile(label: AppConstants.dashboardLabel,    icon: Iconsax.home_2,         color: Color(0xFF1B84FF), routeName: RouteNames.alert_panel),
          ...
          DrawerItem.expandable(
            ...
            children: [
              DrawerItem.tile(label: 'Menu 1', icon: Iconsax.document),
              DrawerItem.tile(label: 'Menu 2', icon: Iconsax.document),
              DrawerItem.tile(label: 'Menu 3', icon: Iconsax.document),
            ],
          ),
          DrawerItem.expandable(
