...
import 'cashbook_ledger_row.dart';

class CashbookYearCard extends StatefulWidget {
  final CashbookStatementEntity yearData;
  final ScrollController? scrollController;
  const CashbookYearCard({super.key, required this.yearData, this.scrollController});

  @override
  State<CashbookYearCard> createState() => _CashbookYearCardState();
}

class _CashbookYearCardState extends State<CashbookYearCard> {
  bool _expanded = true;
  ...
  List<Widget> _buildPagedRows(List<_PagedEntry> entries, BuildContext context) {
    ...
    for (final pe in entries) {
      ...
      widgets.add(CashbookLedgerRow(ledger: pe.entry));
    }
    return widgets;
  }
...
class _PagedEntry {
  final String type;
  final CashbookEntryEntity entry;
