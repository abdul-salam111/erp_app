...
class PartyIdleState extends StatelessWidget {
  const PartyIdleState({super.key});
...
class PartyEmptyState extends StatelessWidget {
  const PartyEmptyState({super.key});
...
class PartyErrorBody extends StatelessWidget {
  final String message;
  final VoidCallback onRetry;
  const PartyErrorBody({super.key, required this.message, required this.onRetry});
