          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                const SizedBox(height: 3),
                Text(
                  formatPartyLedgerBalance((ledger.balance ?? 0).toDouble()),
                  style: context.labelSmall.copyWith(
                    color: context.textSecondary,
                    fontSize: 11,
                  ),
