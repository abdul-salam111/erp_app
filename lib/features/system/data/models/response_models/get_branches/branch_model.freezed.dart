...
@JsonKey(name: 'Id') int? get id;@JsonKey(name: 'Name') String? get name;@JsonKey(name: 'MisOrganizationId') int? get misOrganizationId;@JsonKey(name: 'LocationId') int? get locationId;@JsonKey(name: 'Archived') bool? get archived;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,misOrganizationId,locationId,archived);

@override
String toString() {
  return 'BranchModel(id: $id, name: $name, misOrganizationId: $misOrganizationId, locationId: $locationId, archived: $archived)';
}
...
@useResult
$Res call({
@JsonKey(name: 'Id') int? id,@JsonKey(name: 'Name') String? name,@JsonKey(name: 'MisOrganizationId') int? misOrganizationId,@JsonKey(name: 'LocationId') int? locationId,@JsonKey(name: 'Archived') bool? archived
});
...
/// Create a copy of BranchModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? name = freezed,Object? misOrganizationId = freezed,Object? locationId = freezed,Object? archived = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'Id')  int? id, @JsonKey(name: 'Name')  String? name, @JsonKey(name: 'MisOrganizationId')  int? misOrganizationId, @JsonKey(name: 'LocationId')  int? locationId, @JsonKey(name: 'Archived')  bool? archived)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BranchModel() when $default != null:
return $default(_that.id,_that.name,_that.misOrganizationId,_that.locationId,_that.archived);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'Id')  int? id, @JsonKey(name: 'Name')  String? name, @JsonKey(name: 'MisOrganizationId')  int? misOrganizationId, @JsonKey(name: 'LocationId')  int? locationId, @JsonKey(name: 'Archived')  bool? archived)  $default,) {final _that = this;
switch (_that) {
case _BranchModel():
return $default(_that.id,_that.name,_that.misOrganizationId,_that.locationId,_that.archived);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'Id')  int? id, @JsonKey(name: 'Name')  String? name, @JsonKey(name: 'MisOrganizationId')  int? misOrganizationId, @JsonKey(name: 'LocationId')  int? locationId, @JsonKey(name: 'Archived')  bool? archived)?  $default,) {final _that = this;
switch (_that) {
case _BranchModel() when $default != null:
return $default(_that.id,_that.name,_that.misOrganizationId,_that.locationId,_that.archived);case _:
  return null;
...
class _BranchModel implements BranchModel {
  const _BranchModel({@JsonKey(name: 'Id') this.id, @JsonKey(name: 'Name') this.name, @JsonKey(name: 'MisOrganizationId') this.misOrganizationId, @JsonKey(name: 'LocationId') this.locationId, @JsonKey(name: 'Archived') this.archived});
...
/// Create a copy of BranchModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? name = freezed,Object? misOrganizationId = freezed,Object? locationId = freezed,Object? archived = freezed,}) {
