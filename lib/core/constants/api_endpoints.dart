...
final class _Accounts {
  ...
  String get customerReceivableAging =>
      '$_execBase/creditmanagement/GetCustomerReceivableAging';
  String get partyCreditMonthlySummary =>
      '$_execBase/creditmanagement/GetPartyCreditMonthWiseSummary';
  String get partyUnpaidDebits =>
      '$_execBase/creditmanagement/GetPartyUnpaidDebits';
  String get partyTopReceipts =>
      '$_execBase/creditmanagement/GetPartyTopReceipts';
  String get partyRevenueAndRecovery =>
      '$_execBase/creditmanagement/GetPartyRevenueAndRecovery';
...
final class _PurchaseOrders {
  ...
  String get getPurchaseOrdersList =>
      '${ApiEndPoints._base}/purchase/po/getPagedList';
  String getPurchaseOrderById(int id) =>
      '${ApiEndPoints._base}/purchase/po/GetById/$id';
}
...
final class _SaleOrders {
  ...
  String getSaleOrderById(int id) =>
      '${ApiEndPoints._base}/sale/so/GetById/$id';
}
...
final class _Leaves {
  ...
  static String get _base => '${ApiEndPoints._base}/ExecutiveApp/hr/leave';

  String get applyLeave => '$_base/Create';
  String get getLeaves => '$_base/GetLeaves';
  String get getBalances => '$_base/GetBalances';
  String get getById => '$_base/GetById';
}
