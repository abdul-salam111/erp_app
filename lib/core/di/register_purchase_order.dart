...
import '../../features/purchase_order/domain/usecases/get_purchase_order_by_id_usecase.dart';
import '../../features/purchase_order/domain/usecases/get_parties_usecase.dart';
...
Future<void> registerPurchaseOrder() async {
  ...
  // UseCases — CreatePurchaseOrder
  sl.registerLazySingleton<CreatePurchaseOrderUsecase>(
    () => CreatePurchaseOrderUsecase(repository: sl()),
  );
  sl.registerLazySingleton<GetPurchaseOrderByIdUsecase>(
    () => GetPurchaseOrderByIdUsecase(repository: sl()),
  );
  sl.registerLazySingleton<GetPartiesUsecase>(
    () => GetPartiesUsecase(repository: sl()),
  );
